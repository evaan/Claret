...
export default function App() {
    ...
    React.useEffect(() => {
        fetch((process.env.API_URL === undefined ? "http://127.0.0.1:8080" : process.env.API_URL)+"/all").then(response => response.json()).then((data: {subjects: Subject[], courses: Course[], times: Time[], seatings: Seating[]}) => {
